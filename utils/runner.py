...
def model_performance(data: pd.DataFrame, cluser_size: int, cluster_eps: float, cluster_kneigh: int) -> Tuple[object,
                                                                                                              float]:
...
def objective(trial: optuna.trial.Trial, data: pd.DataFrame) -> float:
    ...
    model, score = model_performance(data, cluster_size, cluster_epsilon, cluster_kneighbors)
